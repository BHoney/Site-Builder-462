...
//
//
////	The class defines a series of overloaded method to calculate a sample kernel base on 
////	given standard deviation. For example, to get a kernel for deviation 1, call:
////
...
//
//
//	private System.Drawing.Color grayscale(System.Drawing.Color cr)
//	{
//		return System.Drawing.Color.FromArgb(cr.A, (int)(cr.R * .3 + cr.G * .59 + cr.B * 0.11),
...
//				ret.SetPixel(i, j, System.Drawing.Color.FromArgb(255,val,val,val));
//			}
//		}
//		return ret;
//	}
